object Main {
  def main(args: Array[String]): Unit = {
    val numPuntos = 1000 // Configura el número de puntos que deseas probar
    val eta = 0.001 // Configura el valor de eta
    val k = 20 // Configura el número de medianas

    val resultados = probarKmedianas(numPuntos, eta, k)
    val tiempoSeq = resultados._1
    val tiempoPar = resultados._2
    val tiempoRatio = resultados._3

    println(s"Tiempo secuencial: $tiempoSeq")
    println(s"Tiempo paralelo: $tiempoPar")
    println(s"Ratio de tiempo (secuencial/paralelo): $tiempoRatio")
  }
...
def probarKmedianas(numPuntos:Int, eta:Double, k:Int) = {
  ...
  //Plotly.plot("C:\\Users\\jpant\\OneDrive\\Desktop\\Universidad\\Programación Funcional y Concurrente\\Taller 6\\Lab-6-Algoritmo-KMeans\\kmedianasSeq.html", dataSeq, layoutSeq)
  ...
  Plotly.plot("C:\\Users\\jpant\\OneDrive\\Desktop\\Universidad\\Programación Funcional y Concurrente\\Taller 6\\Lab-6-Algoritmo-KMeans\\kmedianasPar.html", dataPar.toSeq, layoutPar)
